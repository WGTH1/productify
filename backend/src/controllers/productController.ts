...
export const getAllProducts = async (req: Request, res: Response) => {
    try {
        ...
        res.status(500).json({ error: "Failde to get products" });
    }
};

export const getMyPorducts = async (req: Request, res: Response) => {
    try {
...
export const getProductById = async (req: Request, res: Response) => {
    try {
        ...
        // ตรวจสอบว่า id เป็น string เดียว
        if (typeof id !== 'string') {
...
export const createProduct = async (req: Request, res: Response) => {
    try {
        ...
        res.status(500).json({ error: "Failde to create product" });
    }
};
